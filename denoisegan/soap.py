...
class SOAP(optim.Optimizer):
    ...
    Parameters:
        ...
        lr: The learning rate (default: 3e-3).
        betas: Adam's betas (b1, b2) (default: (0.95, 0.95)).
        shampoo_beta: If >= 0, use this beta for preconditioner moving average
        ...
        data_format: Data format for conv layers, "channels_first" or "channels_last" (default: "channels_first").
    ...
    def merge_dims(self, grad, max_precond_dim):
        """Merges dimensions of the gradient tensor till the product is <= max_precond_dim."""
    ...
    def get_orthogonal_matrix_QR(self, state, max_precond_dim=10000, merge_dims=False):
        """Computes eigenbases using one round of power iteration followed by QR decomposition."""
